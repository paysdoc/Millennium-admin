...
async function main(): Promise<void> {
  ...
  const { issueNumber, providedAdwId } = parseCliArguments(args, 'adwPlanBuild.tsx');

  const config = await initializeWorkflow(issueNumber, providedAdwId, 'plan-build-orchestrator');
